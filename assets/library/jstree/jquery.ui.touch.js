...
(function ($) {
    var lastTap           = true,  // Holds last tapped element (so we can compare for double tap)
        tapValid          = true, // Are we still in the .6 second window where a double tap can occur
