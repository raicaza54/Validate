    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-principal" role="tabpanel" aria-labelledby="pills-principal-tab">
            <div class="menu-card-icon">
                <div class="icono <?=$this->permisos->viewaccess('mpe-empresa-listar')?>" id="mpe-empresa-listar" onclick="ADMINTABLERO.methods.metricas()">
                    <i class="fas fa-chart-line"></i>
                    <span><?=nbs(3)?>M&eacute;tricas<?=nbs(3)?></span>
                </div>
                <div class="titulo">Tablero</div>
            </div>
            <div class="menu-separador"></div>            
            <div class="menu-card-icon">
                <div class="icono <?=$this->permisos->viewaccess('mpe-empresa-listar')?>" id="mpe-empresa-listar" onclick="">
                    <i class="fas fa-archive"></i>
                    <span><?=nbs(3)?>Listar<?=nbs(3)?></span>
                </div>                
                <div class="icono <?=$this->permisos->viewaccess('mpe-empresa-crear')?>" id="mpe-empresa-crear" onclick="">
            ...
            <div class="menu-separador"></div>
            <div class="menu-card-icon">
                <div class="icono <?=$this->permisos->viewaccess('mpe-importar-archivo')?>" id="mpe-importar-archivo" onclick="">
