<div class="row">
    <div class="col-sm-3 text-center align-middle" style="padding-top: 2.5em;">
        <?= asset_image('logo3.png" style="height: 50px;"')?>
    </div>
    <div class="col-sm-9">
        <p>
            <h4><b>Terminos y Condiciones</b></h4> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
        </p>    
    </div>    
</div>
<div class="col-sm-12 shadow-sm" style="background-color: #fff; height: 55vh; border-radius: 4px; overflow-x: hidden; overflow-y: auto; padding: 20px;">
    <p>
...
<div class="row">
    <?=form_open(base_url('terminosCondiciones'),array('class' => 'text-right col-sm-12 mt-3'),array('terminos' => 'ok'))?>
        <button type="submit" class="btn btn-primary" style="font-size: 12px;">
            Aceptar Terminos y Condiciones y continuar
        </button>
    <?=form_close()?>
</div>