<div class="row">
    <div class="col-sm-12 text-center align-middle" style="padding: 1em 0px 2em 0px;">
        <?= asset_image('logo3.png" style="height: 50px;"')?>
    </div>
</div>
<div class="col-sm-12 shadow-sm" style="background-color: #fff; height: 64vh; border-radius: 4px; overflow-x: hidden; overflow-y: auto; padding: 20px;">
