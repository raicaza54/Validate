 ...
 */
$config['tables']['users']          = 'auth__users';
$config['tables']['groups']         = 'auth__groups';
$config['tables']['users_groups']   = 'auth__users_groups';
$config['tables']['login_attempts'] = 'auth__login_attempts';
 ...
 */
$config['site_title']                 = "Validate";       // Site Title, example.com
$config['admin_email']                = "kevin.g.enriquez.c@gmail.com"; // Admin Email, admin@example.com
