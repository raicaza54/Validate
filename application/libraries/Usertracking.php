...
class Usertracking {
    ...
    private $needed_fields = array(
        ...
        array('name' => 'timestamp', 'type' => 'date', 'forge_type' => 'datetime'),
        ...
        array('name' => 'class', 'type' => 'string', 'forge_type' => 'varchar', 'forge_constraint' => '255'),
        array('name' => 'method', 'type' => 'string', 'forge_type' => 'varchar', 'forge_constraint' => '255'),
        array('name' => 'post', 'type' => 'text', 'forge_type' => 'text'),
        array('name' => 'resultado', 'type' => 'text', 'forge_type' => 'text'),
        array('name' => 'pid', 'type' => 'string', 'forge_type' => 'varchar', 'forge_constraint' => '10'),
    );
    ...
    private function check_database() {
        ...
        if ($this->CI->db->table_exists($this->table)) {
            ...
            if ($num_matched < count($this->needed_fields) && $this->configuration['auto_fix_db'] === TRUE) {
                ...
                $this->CI->dbforge->rename_table($db_prefix . $this->table, 'usertracking_backup_' . time());
    ...
    private function build_database_table() {
        ...
        $this->CI->db->query('ALTER TABLE  `'.$this->table.'` ENGINE = MYISAM');
        return TRUE;
    }
