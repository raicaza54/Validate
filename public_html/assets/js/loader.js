...
$(document).ready(function () {
    includeFiles(base_url + '/assets/js/main.js');
    includeFiles(base_url + '/assets/js/plantilla/sidebar.js');
    includeFiles(base_url + '/assets/js/empresas/empresas.js');
    includeFiles(base_url + '/assets/js/explorador/explorador.js');
    includeFiles(base_url + '/assets/js/archivos/archivos.js');
    includeFiles(base_url + '/assets/js/benford/benford.js');
    includeFiles(base_url + '/assets/js/spider/spider.js');
